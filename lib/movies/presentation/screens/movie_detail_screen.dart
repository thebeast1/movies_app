  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => serviceLocator<MovieDetailsBloc>()
        ..add(GetMoviesDetailsEvent(movieId: id))
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, state) {
        log("${state.movieDetailsState} -- ${state.recommendationState}");
          ...
          case RequestState.loaded:
            return SliverGrid(
              delegate: SliverChildBuilderDelegate(
                ...
                childCount: state.recommendationsList == null
                    ? 0
                    : state.recommendationsList!.length,
              ),
